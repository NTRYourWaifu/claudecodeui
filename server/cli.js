...
function showStatus() {
    ...
    console.log(`       CONTEXT_WINDOW: ${c.dim(process.env.CONTEXT_WINDOW || '(unset - follows the selected model)')}`);
...
Environment Variables:
  ...
  CONTEXT_WINDOW      Override the context window budget (default: follows the model)
